...
time=90
bwnet=1.5
delay=10ms  # RTT total é 20ms, portanto o delay é 10ms em cada link.

for qsize in 20 100; do
    dir=bb-q$qsize
    python3 bufferbloat.py --bw-host 1000 --bw-net $bwnet \
        --delay $delay --dir $dir --time $time --maxq $qsize
